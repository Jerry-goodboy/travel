  ...
  return declare([GraphicsLayer], {
      ...
      if ( c.attributes.clusterCount == 1 ) {
        ...
        for ( var i = 0, il = this._clusterData.length; i < il; i++) {
          if ( c.attributes.clusterId == this._clusterData[i].attributes.clusterId ) {
            gra = this._clusterData[i];
          }
        }
        var typestr = gra.attributes.TYPE;
        var pcsymbol = new PictureMarkerSymbol((typestr=="幼儿园"?"images/y.png":(typestr=="小学"?"images/s.png":"images/m.png")), 30, 30).setOffset(0, 12);
    ...
    _addSingles: function(singles) {
      ...
      arrayUtils.forEach(singles, function(p) {
        var typestr = p.attributes.TYPE;
        var g = new Graphic(
          new Point(p.x, p.y, this._sr),
          new PictureMarkerSymbol((typestr=="幼儿园"?"images/y.png":(typestr=="小学"?"images/s.png":"images/m.png")), 30, 30),
          p.attributes
